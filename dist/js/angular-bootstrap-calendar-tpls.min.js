...
!function(e, t) {
    ...
    }()); else if ("function" == typeof define && define.amd)define(["angular", "moment", "interact"], t); else {
    ...
    return function(e) {
        ...
        e.exports = '<div class=cal-day-panel-hour><div class=cal-day-hour ng-repeat="hour in vm.hours track by $index"><div class="row-fluid cal-day-hour-part"><div class="span1 col-xs-1"><strong ng-bind=hour.label></strong></div><div class="span11 col-xs-11"></div></div><div class="row-fluid cal-day-hour-part"><div class="span1 col-xs-1"></div><div class="span11 col-xs-11"></div></div><div class="row-fluid cal-day-hour-part" ng-show="vm.dayViewSplit < 30"><div class="span1 col-xs-1"></div><div class="span11 col-xs-11"></div></div><div class="row-fluid cal-day-hour-part" ng-show="vm.dayViewSplit < 30"><div class="span1 col-xs-1"></div><div class="span11 col-xs-11"></div></div><div class="row-fluid cal-day-hour-part" ng-show="vm.dayViewSplit < 15"><div class="span1 col-xs-1"></div><div class="span11 col-xs-11"></div></div><div class="row-fluid cal-day-hour-part" ng-show="vm.dayViewSplit < 15"><div class="span1 col-xs-1"></div><div class="span11 col-xs-11"></div></div></div></div>'
    }, function(e, t) {
        e.exports = '<div mwl-droppable on-drop="vm.handleEventDrop(dropData.event, day.date)" class="cal-month-day {{ day.cssClass }}" data-toggle=collapse ng-class="{\n        \'cal-day-outmonth\': !day.inMonth,\n        \'cal-day-inmonth\': day.inMonth,\n        \'cal-day-weekend\': day.isWeekend,\n        \'cal-day-past\': day.isPast,\n        \'cal-day-today\': day.isToday,\n        \'cal-day-future\': day.isFuture\n      }"><small class="cal-events-num badge badge-important pull-left" ng-show="day.badgeTotal > 0" ng-bind=day.badgeTotal></small> <span class=pull-right data-cal-date ng-click=vm.calendarCtrl.drillDown(day.date) ng-bind=day.label></span><div class=cal-day-tick ng-show="dayIndex === vm.openDayIndex && vm.view[vm.openDayIndex].events.length > 0"><i class="glyphicon glyphicon-chevron-up"></i> <i class="fa fa-chevron-up"></i></div><div ng-include="\'calendarMonthEventsList.html\'"></div></div>'
    }, function(e, t) {
        e.exports = '<div class=events-list ng-show="day.events.length > 0"><a ng-repeat="event in day.events | orderBy:\'startsAt\' track by event.$id" href=javascript:; ng-click="vm.onEventClick({calendarEvent: event})" class="pull-left event" ng-class="\'event-\' + event.type + \' \' + event.cssClass" ng-mouseenter="vm.highlightEvent(event, true)" ng-mouseleave="vm.highlightEvent(event, false)" tooltip-append-to-body=true tooltip-html-unsafe="{{ (event.startsAt | calendarDate:\'time\':true) + \' - \' + event.title }}" mwl-draggable="event.draggable === true" drop-data="{event: event}"></a></div>'
    }, function(e, t) {
        ...
        a.module("mwl.calendar").controller("MwlCalendarCtrl", ["$scope", "$log", "$timeout", "$window", "$attrs", "$locale", "moment", "calendarTitle", function(e, t, n, r, i, l, s, d) {
            ...
            function c() {
                d[v.view] && a.isDefined(i.viewTitle) && (v.viewTitle = d[v.view](v.currentDay)), v.events = v.events.filter(o).map(function(e, t) {
                    return Object.defineProperty(e, "$id", {enumerable: !1, configurable: !0, value: t}), e
                });
                var t = s(v.currentDay), n = !0;
                m.clone().startOf(v.view).isSame(t.clone().startOf(v.view)) && !m.isSame(t) && v.view === u && (n = !1), m = t, u = v.view, n && e.$broadcast("calendar.refreshView")
            }

            var v = this;
            v.events = v.events || [], v.changeView = function(e, t) {
                v.view = e, v.currentDay = t
            }, v.drillDown = function(e) {
                var t = s(e).toDate(), n = {year: "month", month: "day", week: "day"};
                v.onDrillDownClick({calendarDate: t, calendarNextView: n[v.view]}) !== !1 && v.changeView(n[v.view], t)
            };
            var m = s(v.currentDay), u = v.view, f = !1;
            e.$watchGroup(["vm.currentDay", "vm.view", function() {
                return s.locale() + l.id
            }], function() {
                f ? c() : (f = !0, e.$watch("vm.events", c, !0))
            })
        ...
        "use strict";
        var a = n(1);
        a.module("mwl.calendar").controller("MwlCalendarDayCtrl", ["$scope", "$timeout", "$sce", "moment", "calendarHelper", "calendarConfig", function(e, t, n, a, r, i) {
            var l = this;
            l.calendarConfig = i, l.$sce = n, e.$on("calendar.refreshView", function() {
                l.dayViewSplit = l.dayViewSplit || 30, l.dayViewHeight = r.getDayViewHeight(l.dayViewStart, l.dayViewEnd, l.dayViewSplit), l.view = r.getDayView(l.events, l.currentDay, l.dayViewStart, l.dayViewEnd, l.dayViewSplit)
            }), l.eventDragComplete = function(e, t) {
                var n = t * l.dayViewSplit, r = a(e.startsAt).add(n, "minutes"), i = a(e.endsAt).add(n, "minutes");
                delete e.tempStartsAt, l.onEventTimesChanged({
                    calendarEvent: e,
                    calendarNewEventStart: r.toDate(),
                    calendarNewEventEnd: i.toDate()
                })
            }, l.eventDragged = function(e, t) {
                var n = t * l.dayViewSplit;
                e.tempStartsAt = a(e.startsAt).add(n, "minutes").toDate()
            }, l.eventResizeComplete = function(e, t, n) {
                var r = n * l.dayViewSplit, i = a(e.startsAt), s = a(e.endsAt);
                "start" === t ? i.add(r, "minutes") : s.add(r, "minutes"), delete e.tempStartsAt, l.onEventTimesChanged({
                    calendarEvent: e,
                    calendarNewEventStart: i.toDate(),
                    calendarNewEventEnd: s.toDate()
                })
            }, l.eventResized = function(e, t, n) {
                var r = n * l.dayViewSplit;
        ...
        a.module("mwl.calendar").controller("MwlCalendarHourListCtrl", ["$scope", "moment", "calendarConfig", "calendarHelper", function(e, t, n, a) {
            function r() {
                ...
                for (var e = t(i), r = 0; r <= l.diff(i, "hours"); r++)s.hours.push({label: a.formatDate(e, n.dateFormats.hour)}), e.add(1, "hour")
            }

            var i, l, s = this, d = t.locale();
            e.$on("calendar.refreshView", function() {
                d !== t.locale() && (d = t.locale(), r())
            }), e.$watchGroup(["vm.dayViewStart", "vm.dayViewEnd", "vm.dayViewSplit"], function() {
                r()
            })
            ...
            return {
                ...
                scope: {dayViewStart: "=", dayViewEnd: "=", dayViewSplit: "="},
                bindToController: !0
            }
        }])
    }, function(e, t, n) {
        "use strict";
        var a = n(1);
        a.module("mwl.calendar").controller("MwlCalendarMonthCtrl", ["$scope", "moment", "calendarHelper", function(e, t, n) {
            var a = this;
            e.$on("calendar.refreshView", function() {
                a.weekDays = n.getWeekDayNames(), a.view = n.getMonthView(a.events, a.currentDay, a.cellModifier);
                var e = Math.floor(a.view.length / 7);
                a.monthOffsets = [];
                for (var r = 0; e > r; r++)a.monthOffsets.push(7 * r);
                a.autoOpen && a.view.forEach(function(e) {
                    e.inMonth && t(a.currentDay).startOf("day").isSame(e.date) && !a.openDayIndex && a.dayClicked(e, !0)
                })
            }), a.dayClicked = function(e, t) {
                t || a.onTimespanClick({calendarDate: e.date.toDate()}), a.openRowIndex = null;
                var n = a.view.indexOf(e);
                n === a.openDayIndex ? a.openDayIndex = null : (a.openDayIndex = n, a.openRowIndex = Math.floor(n / 7))
            }, a.highlightEvent = function(e, t) {
                a.view.forEach(function(n) {
                ...
                var i = t(e.startsAt).date(t(r).date()).month(t(r).month()), l = n.adjustEndDateFromStartDiff(e.startsAt, i, e.endsAt);
        ...
        "use strict";
        var a = n(1);
        a.module("mwl.calendar").controller("MwlCalendarSlideBoxCtrl", ["$sce", function(e) {
            var t = this;
            t.$sce = e
        ...
        a.module("mwl.calendar").controller("MwlCalendarWeekCtrl", ["$scope", "$sce", "moment", "calendarHelper", "calendarConfig", function(e, t, n, a, r) {
            ...
            i.showTimes = r.showTimesOnWeekView, i.$sce = t, e.$on("calendar.refreshView", function() {
                ...
                var r = n(e.startsAt).add(t, "days"), l = n(e.endsAt).add(t, "days");
                if (a) {
                ...
                var r = n(e.startsAt), l = n(e.endsAt);
        ...
        a.module("mwl.calendar").controller("MwlCalendarYearCtrl", ["$scope", "moment", "calendarHelper", function(e, t, n) {
            ...
            e.$on("calendar.refreshView", function() {
                ...
                var i = t(e.startsAt).month(t(r).month()), l = n.adjustEndDateFromStartDiff(e.startsAt, i, e.endsAt);
                a.onEventTimesChanged({
                    calendarEvent: e,
                    calendarDate: r,
                    calendarNewEventStart: i.toDate(),
        ...
        a.module("mwl.calendar").controller("MwlCollapseFallbackCtrl", ["$scope", "$attrs", "$element", function(e, t, n) {
            ...
            return e.has("collapseDirective") ? {} : {restrict: "A", controller: "MwlCollapseFallbackCtrl"}
        }])
    }, function(e, t, n) {
        "use strict";
        var a = n(1);
        ...
        "use strict";
        var a = n(1);
        a.module("mwl.calendar").controller("MwlDraggableCtrl", ["$element", "$scope", "$window", "$parse", "$attrs", "$timeout", "interact", function(e, t, n, r, i, l, s) {
            function d(e, t) {
                return e.css("transform", t).css("-ms-transform", t).css("-webkit-transform", t)
            }
            ...
            if (s) {
                var v, m;
                i.snapGrid && (m = r(i.snapGrid)(t), v = {targets: [s.createSnapGrid(m)]}), s(e[0]).draggable({
                    snap: v,
                    onstart: function(e) {
                        o() && (a.element(e.target).addClass("dragging-active"), e.target.dropData = r(i.dropData)(t), e.target.style.pointerEvents = "none", i.onDragStart && (r(i.onDragStart)(t), t.$apply()))
                    },
                    onmove: function(e) {
                        if (o()) {
                            var l = a.element(e.target), s = (parseFloat(l.attr("data-x")) || 0) + (e.dx || 0), v = (parseFloat(l.attr("data-y")) || 0) + (e.dy || 0);
                            switch (r(i.axis)(t)) {
                                case"x":
                                    v = 0;
                                    break;
                            ...
                            "static" === n.getComputedStyle(l[0]).position && l.css("position", "relative"), d(l, "translate(" + s + "px, " + v + "px)").css("z-index", 1e3).attr("data-x", s).attr("data-y", v), i.onDrag && (r(i.onDrag)(t, c(s, v, m)), t.$apply())
                        }
                    },
                    onend: function(e) {
                        if (o()) {
                            var n = a.element(e.target), l = n.attr("data-x"), s = n.attr("data-y");
                            e.target.style.pointerEvents = "auto", i.onDragEnd && (r(i.onDragEnd)(t, c(l, s, m)), t.$apply()), d(n, null).removeAttr("data-x").removeAttr("data-y").removeClass("dragging-active")
                        }
                    }
        ...
        a.module("mwl.calendar").controller("MwlDroppableCtrl", ["$element", "$scope", "$parse", "$attrs", "interact", function(e, t, n, r, i) {
            i && (i(e[0]).dropzone({
                ondragenter: function(e) {
                    ...
                    e.relatedTarget.dropData && (n(r.onDrop)(t, {dropData: e.relatedTarget.dropData}), t.$apply())
                }
            }), t.$on("$destroy", function() {
                i(e[0]).unset()
            }))
        ...
        a.module("mwl.calendar").controller("MwlElementDimensionsCtrl", ["$element", "$scope", "$parse", "$attrs", function(e, t, n, a) {
            n(a.mwlElementDimensions).assign(t, {width: e[0].offsetWidth, height: e[0].offsetHeight})
        ...
        a.module("mwl.calendar").controller("MwlResizableCtrl", ["$element", "$scope", "$parse", "$attrs", "interact", function(e, t, n, r, i) {
            ...
            if (i) {
                var d, o;
                r.snapGrid && (o = n(r.snapGrid)(t), d = {targets: [i.createSnapGrid(o)]});
                var c, v = {}, m = {};
                i(e[0]).resizable({
                    edges: n(r.resizeEdges)(t), snap: d, onstart: function(e) {
                        if (l()) {
                            c = "end";
                        ...
                        if (l()) {
                            var i = a.element(e.target), d = parseFloat(i.data("x") || 0), v = parseFloat(i.data("y") || 0);
                            i.css({
                        ...
                        if (l()) {
                            var i = a.element(e.target), d = s(c, i, o);
        ...
        var r = n(1), i = "mwl.calendar";
        r.module(i, []).constant("calendarUseTemplates", !0).run(["$templateCache", "calendarUseTemplates", function(e, t) {
            t && (e.put("calendarMonthEventsList.html", n(7)), e.put("calendarMonthDay.html", n(6)))
        }]), a(n(34)), a(n(35)), a(n(36)), e.exports = i
    }, function(e, t, n) {
        "use strict";
        var a = n(1);
        a.module("mwl.calendar").provider("calendarConfig", function() {
            ...
            }, t = "angular", n = a.copy(e[t].date), r = a.copy(e[t].title), i = !1, l = {
                eventsLabel: "Events",
                timeLabel: "Time"
            }, s = !1, d = this;
            d.setDateFormats = function(e) {
                return a.extend(n, e), d
            }, d.setTitleFormats = function(e) {
                return a.extend(r, e), d
            }, d.setI18nStrings = function(e) {
                return a.extend(l, e), d
            }, d.setDisplayAllMonthEvents = function(e) {
                return s = e, d
            }, d.setDateFormatter = function(i) {
                if (-1 === ["angular", "moment"].indexOf(i))throw new Error("Invalid date formatter. Allowed types are angular and moment.");
                return t = i, n = a.copy(e[t].date), r = a.copy(e[t].title), d
            }, d.showTimesOnWeekView = function(e) {
                return i = e, d
            }, d.$get = function() {
                return {
                    dateFormats: n,
        ...
        a.module("mwl.calendar").factory("calendarHelper", ["dateFilter", "moment", "calendarConfig", function(e, t, n) {
            ...
            function l(e, n, r) {
                var l = t(e.startsAt), s = t(e.endsAt || e.startsAt);
                if (n = t(n), r = t(r), a.isDefined(e.recursOn)) {
                    switch (e.recursOn) {
                        case"year":
                            ...
                            break;
                        case"month":
                            l.set({year: n.year(), month: n.month()});
                            break;
                        default:
                            throw new Error("Invalid value (" + e.recursOn + ") given for recurs on. Can only be year, month or week.")
                    }
                    s = i(e.startsAt, l, s)
                }
            ...
            function d(e, n, a) {
                var r = t(e).startOf(n), i = t(e).endOf(n);
                return s(a, r, i)
            }
            ...
            function v(e, a, i) {
                for (var l = [], c = d(a, "year", e), v = t(a).startOf("year"), m = 0; 12 > m;) {
                    var u = v.clone(), f = u.clone().endOf("month"), p = s(c, u, f), w = {
                    ...
                    i({calendarCell: w}), l.push(w), v.add(1, "month"), m++
                }
                return l
            }

            function m(e, a, r) {
                var i, l = t(a).startOf("month"), d = l.clone().startOf("week"), c = t(a).endOf("month").endOf("week");
                i = n.displayAllMonthEvents ? s(e, d, c) : s(e, l, l.clone().endOf("month"));
                for (var v = [], m = t().startOf("day"); d.isBefore(c);) {
                    var u = d.month() === t(a).month(), f = [];
                    ...
                    r({calendarCell: p}), v.push(p), d.add(1, "day")
                }
                return v
            }
            ...
            function u(e, a) {
                ...
                var v = s(e, i, l).map(function(e) {
                    var n, a, r = t(e.startsAt).startOf("day"), s = t(e.endsAt || e.startsAt).startOf("day"), d = t(i).startOf("day"), o = t(l).startOf("day");
                    return n = r.isBefore(d) || r.isSame(d) ? 0 : r.diff(d, "days"),
                    s.isAfter(o) && (s = o), r.isBefore(d) && (r = d), a = t(s).diff(r, "days") + 1, e.daySpan = a, e.dayOffset = n, e
                });
                return {days: o, events: v}
            }

            function f(e, n, a, r, i) {
                var d = t(a || "00:00", "HH:mm").hours(), o = t(r || "23:00", "HH:mm").hours(), c = 60 / i * 30, v = t(n).startOf("day").add(d, "hours"), m = t(n).startOf("day").add(o, "hours"), u = (o - d + 1) * c, f = c / 60, p = [], w = s(e, t(n).startOf("day").toDate(), t(n).endOf("day").toDate());
                return w.map(function(e) {
                    if (t(e.startsAt).isBefore(v) ? e.top = 0 : e.top = t(e.startsAt).startOf("minute").diff(v.startOf("minute"), "minutes") * f - 2, t(e.endsAt || e.startsAt).isAfter(m))e.height = u - e.top; else {
                        var n = e.startsAt;
            ...
            function w(e, n, a) {
                var r = t(e || "00:00", "HH:mm"), i = t(n || "23:00", "HH:mm"), l = 60 / a * 30;
        ...
        a.module("mwl.calendar").factory("calendarTitle", ["moment", "calendarConfig", "calendarHelper", function(e, t, n) {
            ...
            return {day: a, week: r, month: i, year: l}
        }])
    }, function(e, t, n) {
        "use strict";
        var a, r = n(1);
        ...
        var i = {"./calendarDate.js": 25, "./calendarLimitTo.js": 26, "./calendarTruncateEventTitle.js": 27};
        a.keys = function() {
            return Object.keys(i)
